...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=384, patch_size=16, embed_dim=768, depths=2, num_heads=12,
                 window_size=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,
                 norm_layer=nn.LayerNorm, ape=False, use_checkpoint=False, weight_init='', **kwargs):
        super().__init__()
