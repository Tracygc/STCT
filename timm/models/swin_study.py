...
from .vision_transformer import _init_vit_weights
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=384, patch_size=16, in_chans=3, embed_dim=768, depths=12, num_heads=12,
                 window_size=8, mlp_ratio=4., patch_norm=True, qkv_bias=True, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0.1, norm_layer=nn.LayerNorm, ape=False, use_checkpoint=False,
                 weight_init='', **kwargs):
        super().__init__()
    ...
    def forward(self, src_tokens):
        x = self.forward_features(src_tokens)
        return x
